...
#data = create_img_dataset('lena_std.png',512,512,4,4)
data=data/255
...
W_Input_Hidden_0 = classifier.layers[0].get_weights()
W_Input_Hidden_1 = classifier.layers[1].get_weights()
...
classifier_new.layers[0].set_weights(W_Input_Hidden_2)
...
W_Input_Hidden = classifier.layers[0].get_weights()[0]
